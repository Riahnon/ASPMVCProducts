namespace ASPMVCSignalRTest.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ASPMVCSignalRTest.Models.ProductsDb>
    {
        ...
        protected override void Seed(ASPMVCSignalRTest.Models.ProductsDb context)
        {
            SeedMembership();
